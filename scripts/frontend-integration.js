 ...
 * This file demonstrates how to integrate Kitelens with a web frontend
 */

// For React/Vue/Angular applications
export class KitelensClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new KitelensClient(provider, contractAddress);
